  ...
  return (
    <div className="min-h-screen bg-background-light dark:bg-background-dark">
      ...
      <div className="relative" onClick={() => isSideNavOpen && handleSideNavClose()}>
        ...
        {/* Store Section */}
        <section ref={storeRef} className="min-h-screen pt-16 pb-12"> {/* Added pb-12 for bottom spacing */}
          <div className="container mx-auto px-4 sm:px-6 md:px-8 max-w-7xl">
            <div className="mt-8 space-y-2"> {/* Added space-y-2 for consistent spacing */}
            ...
            <div className="mt-6 sm:mt-8"> {/* Adjusted spacing */}
              <SearchBox />
            </div>
            ...
            <div className="mt-6 sm:mt-8"> {/* Adjusted spacing */}
              {isLoading ? (
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 xl:grid-cols-8 gap-4 sm:gap-6">
                  {books.map((book) => (
                    <div key={book.id} className="flex justify-center"> {/* Center cards */}
                      <BookCard
