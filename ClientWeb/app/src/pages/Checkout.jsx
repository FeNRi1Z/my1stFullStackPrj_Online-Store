...
import { PenLine, ArrowRight, ArrowLeft, CheckCircle, Loader2, X, Minus, Plus, Store } from "lucide-react";
	...
	const renderStep = () => {
		switch (currentStep) {
			...
			case 3:
				return (
					<div className="space-y-4 w-full">
						<h2 className="text-text-dark dark:text-text-light text-xl font-semibold mb-24">Order Complete</h2>
						<div className="flex flex-col items-center gap-6">
							...
							<div className="text-center">
								...
								<p className="text-text-dark dark:text-text-light">Order Date: {new Date().toLocaleString()}</p>
							</div>
							{paymentMethod === "qr" && (
								<>
									<p className="text-secondary-50 dark:text-secondary-100">Account number: 123-456-7890</p>
									<p className="text-secondary-50 dark:text-secondary-100">Please upload payment slip to your order</p>
								</>
							)}
						</div>
					</div>
