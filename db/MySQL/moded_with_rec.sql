...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 20, 2024 at 09:55 PM
...
(1, 'Echoes of Silence', 234, 569, 297, 'noIMGFile', 'use', 'A haunting tale of personal discovery and emotional resilience.', 8),
(2, 'The Science of Success', 235, 500, 244, 'noIMGFile', 'use', 'Evidence-based approaches to personal and professional achievement.', 4),
(3, 'Quantum Horizon', 1200, 1400, 280, 'noIMGFile', 'use', 'A mind-bending journey through the frontiers of quantum physics.', 3),
(4, 'Coding Masterclass', 417, 575, 357, 'noIMGFile', 'use', 'Comprehensive guide to modern programming techniques and best practices.', 11),
(5, 'Emotional Intelligence', 234, 333, 564, 'noIMGFile', 'use', 'Practical strategies for understanding and improving emotional awareness.', 7),
(6, 'Echoes of Silence', 1156, 1300, 101, 'noIMGFile', 'use', 'A haunting tale of personal discovery and emotional resilience.', 9),
(7, 'The Digital Revolution', 776, 863, 110, 'noIMGFile', 'use', 'Exploring the transformative impact of technology on modern society.', 4),
(8, 'Shadows of Yesterday', 804, 900, 235, 'noIMGFile', 'use', 'A gripping mystery that unravels decades-old secrets.', 6),
(9, 'The Secrets of the Universe', 120, 250, 55, 'noIMGFile', 'use', 'An intriguing exploration of the cosmos and the mysteries it holds.', 12),
(10, 'Mastering Python', 180, 350, 45, 'noIMGFile', 'use', 'A comprehensive guide for programmers to master Python programming.', 14),
(11, 'The Art of Mindfulness', 90, 150, 75, 'noIMGFile', 'use', 'Learn techniques to achieve a peaceful and mindful life.', 15),
(12, 'Adventures in Wonderland', 110, 220, 48, 'noIMGFile', 'use', 'A thrilling fantasy novel that takes you on an extraordinary journey.', 16),
(13, 'History\'s Greatest Empires', 150, 250, 76, 'noIMGFile', 'use', 'An insightful look into the rise and fall of some of the greatest empires in history.', 17),
(14, 'Culinary Delights', 100, 200, 44, 'noIMGFile', 'use', 'A cookbook filled with recipes from around the world.', 18),
(15, 'The Financial Roadmap', 120, 220, 267, 'noIMGFile', 'use', 'Your guide to financial independence and wealth-building strategies.', 19);
...
(4, 'Client03', 'c03', 'c03', 'client', 'use', 'Street:  292/11-2 Larnluang Si Yaek Mahanak\nCity:  Dusit\nState/province/area:    Bangkok\nZip code:  10300\nCountry:  Thailand', '0228299157', 'noIMGFile', 0, 0),
